...
from data_make import data_set, K_Folder
...
def train_model(device, model, dataloader_train, dataloader_val, criterion, optimizer, scheduler, num_epochs, KF):
    ...
    for epoch in range(num_epochs):
        ...
        total_acc4feature_2 = 0.0
        total_acc4feature_3 = 0.0
        for k in range(0, KF):
...
#                        gt, g_index = torch.max(labels, 1)
                    ...
                    #running_corrects += torch.sum(p_index == gt.data)
                if phase == 'train':
                    scheduler.step()
            
                epoch_loss = running_loss / data_size
                #epoch_acc = running_corrects.double() / data_size
                epoch_acc4feature_1 = accuracy_score(s_1, l_1)
                epoch_acc4feature_2 = accuracy_score(s_2, l_2)
                epoch_acc4feature_3 = accuracy_score(s_3, l_3)
                    
                print('{} Loss: {:.4f} Acc4feature_1: {:.4f} Acc4feature_2: {:.4f} Acc4feature_3: {:.4f}'.format(phase, 
                                                                                                                epoch_loss, 
                                                                                                                epoch_acc4feature_1, 
                                                                                                                epoch_acc4feature_2,
                                                                                                                epoch_acc4feature_3))
                ...
                if phase == 'val':
                    total_acc4feature_1 = total_acc4feature_1 + epoch_acc4feature_1
                    total_acc4feature_2 = total_acc4feature_2 + epoch_acc4feature_2
                    total_acc4feature_3 = total_acc4feature_3 + epoch_acc4feature_3
                    mean_epoch_acc = (epoch_acc4feature_1 + epoch_acc4feature_2 + total_acc4feature_3)/float(3)

                # deep copy the model
                if phase == 'val' and mean_epoch_acc > best_acc:
                    best_acc = mean_epoch_acc
                    best_model_wts = copy.deepcopy(model.state_dict())
   
            print()
        Mean_Accuracy4feature_1 = total_acc4feature_1/float(KF)
        Mean_Accuracy4feature_2 = total_acc4feature_2/float(KF)
        Mean_Accuracy4feature_3 = total_acc4feature_3/float(KF)
        print('Mean_Accuracy for evaluation: feature_1={:.4f} feature_2={:.4f} feature_3={:.4f}'.format(Mean_Accuracy4feature_1,
                                                                                                        Mean_Accuracy4feature_2,
                                                                                                        Mean_Accuracy4feature_3
                                                                                                        ))
